  ...
  return (
    <div className="About">
      <div className="about-info">
        <h3>About Yvette</h3>
        <p>
          Yvette is a master cosmetologist with over 40 years of experience in the industry. She started her journey as a hair stylist in New Orleans and migrated to Atlanta.
          <br /><br />
